...
urlpatterns = [
    ...
    path('driver_new/', driver_new, name='driver'),
    path('driver_list/', driver_list, name='drivers'),
    path('auto_list/', auto_list, name='auto'),
    path('route_list/', route_list, name='route'),
